...
var leaveBalanceRouter = require("./leaveBalance.routes");
...
var userCertificateRouter = require("./userCertificate.routes");
...
router.use("/userCertificates", userCertificateRouter);
