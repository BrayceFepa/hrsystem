...
router.get(
  ...
  departmentAnnouncement.findAllRecent
);

router.get(
  "/recent/department/:id",
  withAuth.verifyToken,
  departmentAnnouncement.findAllRecentByDeptId
);
...
router.get(
  "/department/:id",
  withAuth.verifyToken,
  departmentAnnouncement.findAllByDeptId
);
...
router.delete(
  ...
  withAuth.verifyToken,
  withAuth.withRoleAdminOrManager,
  departmentAnnouncement.deleteAllByDeptId
);
