...
exports.withRoleFinance = (req, res, next) => {
  var authData = req.authData;
...
exports.withRoleHR = (req, res, next) => {
  var authData = req.authData;
...
exports.withRoleAdminOrFinance = (req, res, next) => {
  var authData = req.authData;
  ...
  User.findOne({
    ...
    if (user) {
      if (user.role === "ROLE_ADMIN" || user.role === "ROLE_FINANCE") {
        req.authData = authData;
        next();
      } else {
        res
...
exports.withRoleAdminOrHR = (req, res, next) => {
  var authData = req.authData;
...
exports.withRoleAdminOrManagerOrHR = (req, res, next) => {
  var authData = req.authData;
